...
public class NeighbourDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(valeur==false)
        {
            imageButton2.setColorFilter(ContextCompat.getColor(this,R.color.colorBlack));
        }
        else
        {
            imageButton2.setColorFilter(ContextCompat.getColor(this,R.color.colorYellow));
        }
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(valeur==false)
                {
                    ...
                    imageButton2.setColorFilter(ContextCompat.getColor(NeighbourDetailsActivity.this,R.color.colorYellow));
                }
                else
                {
                    DI.getNeighbourApiService().deletFavorit(user);
                    imageButton2.setColorFilter(ContextCompat.getColor(NeighbourDetailsActivity.this,R.color.colorBlack));
                }
            }
        });
        // DI.getNeighbourApiService().addFavorit(user);
